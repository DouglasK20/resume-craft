...
export type ResumeArraysKeys = Exclude<keyof ResumeContentData, "image" | "infos" | "summary">;

export type MultipleDragItemData = {
    formKey: ResumeArraysKeys;
    title: string;
    icon: LucideIcon;
    titleKey: string;
                                    ...
                                    {fields.map((field, index) => {
                                        ...
                                        return (
                                            <Draggable key={`draggable-item-${data.formKey}-${index}`} draggableId={`draggable-item-${data.formKey}-${index}`} index={index}>
                                                {(provided) => (
                                                    <div key={field.id} ref={provided.innerRef} {...provided.draggableProps}
